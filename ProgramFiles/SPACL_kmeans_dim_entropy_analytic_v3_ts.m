...
function [out_opd] = SPACL_kmeans_dim_entropy_analytic_v3_ts(X,Pi,K,N_anneal,out_init,reg_param,X_valid,pi_valid,N_neurons,flag_AUC,flag_parallel)
    ...
    for e = 1:size(L_pred,2)
        ...
        ConfMatr{e}=out{KKK(ii,e)}.confusion_matr_valid;
        ConfMatr_ts{e}=out{KKK(ii,e)}.confusion_matr_valid_ts;
    ...
    out_opd.confusion_matrix = ConfMatr{e};
    out_opd.confusion_matrix_ts = ConfMatr_ts{e};
